...
const seoDescription =
  "Ανδρικά κοσμήματα και αξεσουάρ, τα οποία εκφράζουν την φιλοσοφία του wabi sabi lifestyle, ακολουθώντας χαλαρές, λιτές και μίνιμαλ γραμμές.";
const seoImageSrc = "/assets/images/skulls_stones-desktop.jpg";
